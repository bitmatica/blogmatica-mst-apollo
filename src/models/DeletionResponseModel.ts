...
export interface DeletionResponseModelType
  extends Instance<typeof DeletionResponseModel.Type> {}

/* A graphql query fragment builders for DeletionResponseModel */
export {
  selectFromDeletionResponse,
 ...
 */
export const DeletionResponseModel = DeletionResponseModelBase.actions((self) => ({
