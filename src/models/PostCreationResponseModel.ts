...
export interface PostCreationResponseModelType
  extends Instance<typeof PostCreationResponseModel.Type> {}

/* A graphql query fragment builders for PostCreationResponseModel */
export {
  selectFromPostCreationResponse,
 ...
 */
export const PostCreationResponseModel = PostCreationResponseModelBase.actions((self) => ({
