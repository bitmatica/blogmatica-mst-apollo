...
export interface UserLoginResponseModelType
  extends Instance<typeof UserLoginResponseModel.Type> {}

/* A graphql query fragment builders for UserLoginResponseModel */
export {
  selectFromUserLoginResponse,
 ...
 */
export const UserLoginResponseModel = UserLoginResponseModelBase.actions((self) => ({
