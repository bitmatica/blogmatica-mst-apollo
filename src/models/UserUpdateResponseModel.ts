...
export interface UserUpdateResponseModelType
  extends Instance<typeof UserUpdateResponseModel.Type> {}

/* A graphql query fragment builders for UserUpdateResponseModel */
export {
  selectFromUserUpdateResponse,
 ...
 */
export const UserUpdateResponseModel = UserUpdateResponseModelBase.actions((self) => ({
