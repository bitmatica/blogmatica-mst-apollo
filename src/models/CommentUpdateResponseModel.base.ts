 ...
 */
export const CommentUpdateResponseModelBase = withTypedRefs<Refs>()(
  ModelBase.named("CommentUpdateResponse")
    .props({
      __typename: types.optional(
        types.literal("CommentUpdateResponse"),
...
export const commentUpdateResponseModelPrimitives = selectFromCommentUpdateResponse()
  .success.message
