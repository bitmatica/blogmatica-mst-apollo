 ...
 */
export const UserCreationResponseModelBase = withTypedRefs<Refs>()(
  ModelBase.named("UserCreationResponse")
    .props({
      __typename: types.optional(
        types.literal("UserCreationResponse"),
...
export const userCreationResponseModelPrimitives = selectFromUserCreationResponse().success
  .message
