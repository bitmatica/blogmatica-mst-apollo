...
export interface CommentUpdateResponseModelType
  extends Instance<typeof CommentUpdateResponseModel.Type> {}

/* A graphql query fragment builders for CommentUpdateResponseModel */
export {
  selectFromCommentUpdateResponse,
 ...
 */
export const CommentUpdateResponseModel = CommentUpdateResponseModelBase.actions(
  (self) => ({
