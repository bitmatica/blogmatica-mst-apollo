 ...
 */
export const CommentCreationResponseModelBase = withTypedRefs<Refs>()(ModelBase
  .named('CommentCreationResponse')
  .props({
    __typename: types.optional(types.literal("CommentCreationResponse"), "CommentCreationResponse"),
...
export const commentCreationResponseModelPrimitives = selectFromCommentCreationResponse().success.message
