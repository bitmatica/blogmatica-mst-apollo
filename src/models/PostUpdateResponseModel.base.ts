 ...
 */
export const PostUpdateResponseModelBase = withTypedRefs<Refs>()(
  ModelBase.named("PostUpdateResponse")
    .props({
...
export const postUpdateResponseModelPrimitives = selectFromPostUpdateResponse().success
  .message
