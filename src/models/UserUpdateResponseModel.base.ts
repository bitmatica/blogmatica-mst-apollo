 ...
 */
export const UserUpdateResponseModelBase = withTypedRefs<Refs>()(ModelBase
  .named('UserUpdateResponse')
  .props({
...
export const userUpdateResponseModelPrimitives = selectFromUserUpdateResponse().success.message
