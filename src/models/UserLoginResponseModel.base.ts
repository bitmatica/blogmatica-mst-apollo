 ...
 */
export const UserLoginResponseModelBase = withTypedRefs<Refs>()(ModelBase
  .named('UserLoginResponse')
  .props({
...
export const userLoginResponseModelPrimitives = selectFromUserLoginResponse().success.message.token
